    ...
    <tr>
      ...
      <td valign="TOP"><!--Grade tasks-->
        ...
        <center><!-- Common grading options --> <br/>
          ...
          Feedback Subs[${fn:length(feedbackQueue)}], &nbsp;&nbsp;&nbsp;
          ...
          <table cellspacing="1" cellpadding="2" border="0" width="700">
            <tr bgcolor="#A8C1DA" align="center">
              ...
              <td width="25%"><B>Feedback Queue</B></td>
            ...
            <tr bgcolor="#ECF4FB" align="center">
              ...
              <td><c:forEach items="${feedbackQueue}" var="item">
                ${item}<br/>
              </c:forEach></td>
          ...
          <table cellspacing="1" cellpadding="2" border="0" width="700">
            ...
            <tr bgcolor="#A8C1DA" align="center">
              <td colspan="3"><B>Busy Agent Queue [${fn:length(busyQueue)}]</B></td>
            </tr>
            ...
            <tr bgcolor="#A8C1DA" align="center">
              <td colspan="3"><B>Idle Contest Agent Queue
