...
public class ManagerMediator {
    ...
    public void test(String id, String userId, String task, String language, TempFile tmp, TempFile tmp2, User user) {
        graderManager.test(id, userId, task, language, tmp, tmp2, user);
    }

    public void submit(String id, String userId, Task task, String language, TempFile tmp,
            String sourceFileName, User user) {
