...
public class GradingQueue {
    protected Set<JobRemovalNotified> notifiedOnSubmitRemovalSet = new TreeSet<JobRemovalNotified>();
    protected Set<JobRemovalNotified> notifiedOnTestRemovalSet = new TreeSet<JobRemovalNotified>();
    protected Set<JobRemovalNotified> notifiedOnGradeRemovalSet = new TreeSet<JobRemovalNotified>();
    ...
    private Set<JobRemovalNotified> getNotificationSet(JobType jobType) {
        if (JobType.GRADE.equals(jobType))
            return notifiedOnGradeRemovalSet;
        if (JobType.SUBMIT.equals(jobType))
            return notifiedOnSubmitRemovalSet;
        if (JobType.TEST.equals(jobType))
            return notifiedOnTestRemovalSet;
        if (JobType.FEEDBACK.equals(jobType))
            return notifiedOnSubmitRemovalSet;
