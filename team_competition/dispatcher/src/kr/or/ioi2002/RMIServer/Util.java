...
public class Util 
{
    ...
    public static java.text.SimpleDateFormat sdfDate = new java.text.SimpleDateFormat("yyyy.MM.dd");
    public static java.text.SimpleDateFormat sdfTime = new java.text.SimpleDateFormat("HH:mm:ss");
